<template lang="pug">
  svg(width='256px' height='256px' viewBox='0 0 256 256' version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' preserveaspectratio='xMidYMid')
    defs
      linearGradient#linearGradient-1(x1='41.7030965%' y1='1.92488263%' x2='71.8761384%' y2='95.2347418%')
        stop(stop-color='#00CDD7' offset='28%')
        stop(stop-color='#2086D7' offset='94%')
      linearGradient#linearGradient-2(x1='22.4892241%' y1='15.1271186%' x2='82.8771552%' y2='84.7627119%')
        stop(stop-color='#FFF045' offset='14%')
        stop(stop-color='#00CDD7' offset='37%')
      linearGradient#linearGradient-3(x1='11171%' y1='-27691.7984%' x2='11907%' y2='-28759.6256%')
        stop(stop-color='#00CDD7' offset='28%')
        stop(stop-color='#2086D7' offset='94%')
    g
