<template lang="pug">
  svg#Layer_1(version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' x='0px' y='0px' width='70px' height='70px' viewBox='0 0 70 70' style='enable-background:new 0 0 70 70;' xml:space='preserve')
    linearGradient#SVGID_1_(gradientunits='userSpaceOnUse' x1='0.558' y1='46.8457' x2='29.9473' y2='8.0256')
    ...
    linearGradient#SVGID_2_(gradientunits='userSpaceOnUse' x1='2.7297' y1='48.3788' x2='32.0719' y2='9.6209')
      stop(offset='1.612903e-002' style='stop-color:#765AF8')
      stop(offset='0.3821' style='stop-color:#B345F1')
      stop(offset='0.7581' style='stop-color:#FA3293')
      stop(offset='0.9409' style='stop-color:#FF318C')
    polygon(style='fill:url(#SVGID_2_);' points='28,41.4 27.3,20.6 0,13.5 6.7,53.6 28,53.4')
    linearGradient#SVGID_3_(gradientunits='userSpaceOnUse' x1='50.8568' y1='46.405' x2='34.2739' y2='7.0481')
    ...
    linearGradient#SVGID_4_(gradientunits='userSpaceOnUse' x1='63.2656' y1='57.3388' x2='24.6977' y2='27.5158')
      stop(offset='1.612903e-002' style='stop-color:#765AF8')
      stop(offset='0.3821' style='stop-color:#B345F1')
