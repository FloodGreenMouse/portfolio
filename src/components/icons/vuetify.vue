<template lang="pug">
  svg(width='256px' height='293px' viewBox='0 0 256 293' version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' preserveaspectratio='xMidYMid')
    ...
    polyline(fill='#7BC6FF' points='128 182.743732 128 292.459439 0 42.5575194 67.0490402 42.5575194')
    polyline(fill='#AEDDFF' points='128 182.746214 128 292.461921 256 42.5600014 188.95096 42.5600014')
</template>
